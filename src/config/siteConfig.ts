...
export const siteConfig: SiteConfig = {
  meta: {
    ...
    description: "Learn how digital products work — then use ready-made resources, AI automation agents, and organic traffic frameworks to launch your digital product business.",
    ogImage: "/images/og-preview.png",
    supportEmail: "digitalproductlaunchsystem@gmail.com",
  },
  links: {
    checkoutUrl: "https://whop.com/digitalproductlaunchsystem/digital-product-launchs-system/",
    googleDrivePreviewUrl: "https://drive.google.com/drive/folders/launch-system-hub",
  ...
  productLibrary: [
    ...
    {
      id: "video-courses",
      label: "Skill Training & Video Courses",
      count: "1,000+",
      highlight: "Skill-based, practical training modules",
      description: "Video modules covering digital marketing, offer creation, high-conversion landing page design, organic social reach, email marketing, and copywriting.",
  ...
  driveStructure: [
    {
      ...
      description: "The official master orientation guide, 7-step launch roadmap PDF, setup checklist, and folder navigation directory so you know exactly where to begin.",
      fileCount: "Curated Starter Pack",
      highlights: [
        "Welcome & System Orientation Guide",
        "The 7-Step Digital Product Launch Roadmap",
        "System Setup Checklist & Resource Directory",
        "Commercial Licensing & Rights Guidelines PDF"
      ],
      keyDeliverables: ["Orientation Guide", "System Setup Checklist", "Step-by-Step Roadmap PDF"]
    },
    {
      id: "01",
      ...
      description: "Learn how digital products work: unit economics, choosing a validated niche, crafting compelling offers, and understanding sales mechanics.",
      fileCount: "Strategy Guides & Worksheets",
      highlights: [
      ...
      keyDeliverables: ["Strategy Frameworks", "Niche Matrix Sheet", "Pricing Calculator"]
    },
    {
      id: "02",
    ...
    {
      id: "04",
      folderName: "04_MARKETING_RESOURCES",
      title: "Content Strategy & Hook Frameworks",
      badge: "Step 5 • Content Strategy",
      description: "Frameworks, high-retention hooks, and plug-and-play caption scripts to structure your organic social posts effectively.",
      fileCount: "1,000+ Hooks & Caption Frameworks",
      highlights: [
        "Proven Hook & Retention Frameworks",
        "Plug-and-Play Caption Scripts with CTA Triggers",
        "30-Day Content Planning Calendar Template",
        "Organic Content Strategy Playbook"
      ],
      keyDeliverables: ["Hook Swipe File", "Caption Templates", "30-Day Content Calendar"]
    },
    {
      id: "05",
      ...
      badge: "Step 6 • Scale",
      description: "Custom GPT instructions, Claude prompt systems, Midjourney image prompts, and Make/n8n automation blueprints to streamline your workflows.",
    ...
    },
    {
      ...
      title: "Skill Training & Video Modules",
      badge: "Step 7 • Skills",
      description: "Over 1,000 skill video training modules covering graphic design, copywriting, funnel building, audience growth, and business systems.",
      fileCount: "1,000+ Video Modules",
      highlights: [
        "Mastering Organic Social Reach",
        "Direct-Response Copywriting Fundamentals",
        "Email Marketing & Automated Lead Nurturing",
        "Advanced Offer Stacking & Upsells"
      ],
      keyDeliverables: ["Skill Video Modules", "Summary Cheat Sheets", "Resource Guides"]
    },
    {
      id: "07",
      ...
      description: "Zero-ad-spend organic distribution frameworks focusing on organic reach, community engagement, and AI-assisted content distribution.",
    ...
    },
    {
      ...
      description: "The complete pipeline to turn attention into buyers: email welcome sequences, checkout setups, and customer retention systems.",
  ...
  faqs: [
    {
      ...
      answer: "No. The Digital Product Launch System is fundamentally an educational strategy and execution system. While you receive over 15,000+ AI resources, 1,000+ skill courses, and hundreds of ready-made products, the core value is the structured 7-step digital product launch roadmap and 'Launch Hub' that teaches you step-by-step how to validate, rebrand, build your page, attract organic traffic, and sell.",
      category: "General"
    },
    {
      question: "Do I need prior experience or technical skills to start?",
      answer: "No prior technical experience is required. We designed this specifically for beginners. We walk you through simple tools (Canva, Stan Store, Whop, Gumroad) with step-by-step guidance and pre-made templates so you never have to start from a blank screen.",
      category: "General"
    },
    {
    ...
    },
    {
      ...
      answer: "No. The traffic section is focused entirely on organic, zero-ad-spend distribution methods. You'll learn how to leverage social media algorithms, keyword SEO, and AI-assisted content workflows to attract targeted organic viewers without ad budgets.",
      category: "Traffic"
    },
    {
      question: "Does this guarantee specific income or sales results?",
      answer: "No. We believe in 100% honesty and transparency. We provide the education, resources, templates, and organic strategy, but your results depend entirely on your effort, market niche, consistency, execution, and product presentation. We do not make false promises or fabricated revenue guarantees.",
      category: "General"
    },
    {
      question: "What format are the files provided in?",
      answer: "Files are organized in cloud-optimized formats: Canva template links, PDF action guides, TXT/JSON AI prompt blueprints, skill video modules, and standard spreadsheet templates (.xlsx/.csv).",
      category: "Content"
    },
    {
...
- The educational frameworks, launch roadmap, and system layout are proprietary.
...
Because the Digital Product Launch System provides immediate, irrevocable, and full digital access to downloadable master assets, 15K+ AI agents, 1,000+ skill courses, and proprietary strategy blueprints via Google Drive upon checkout completion:
...
3. FAIRNESS COMMITMENT: We provide extensive transparent previews, interactive folder manifests, and clear resource breakdowns before you buy to ensure the system is the right fit for your goals.`,
...
✓ Use the content frameworks, hooks, and caption templates to grow your personal or business social media channels.
...
✗ You may NOT claim copyright over unmodified raw master files or training courses.`,
