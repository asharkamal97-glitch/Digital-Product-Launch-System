...
import { Film, Play, Sparkles, CheckCircle2, TrendingUp, Zap, Calendar, MessageSquare } from 'lucide-react';
  ...
  return (
    <section className="relative py-20 md:py-28 border-t border-white/5 bg-dark-900/60 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-4xl mx-auto rounded-2xl bg-dark-950 border border-white/10 p-6 sm:p-8 space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-xs">
            <div className="p-4 rounded-xl bg-dark-850 border border-white/5 space-y-1.5">
              <span className="text-indigo-400 font-mono font-bold block">01. 3-SEC HOOK</span>
              <p className="text-slate-300">&ldquo;Stop spending 40 hours creating products from scratch. Do this instead...&rdquo;</p>
            </div>
            <div className="p-4 rounded-xl bg-dark-850 border border-white/5 space-y-1.5">
              <span className="text-purple-400 font-mono font-bold block">02. 7-SEC VALUE</span>
              <p className="text-slate-300">Show the clean 3-step customization workflow with aesthetic B-roll background footage.</p>
            </div>
            <div className="p-4 rounded-xl bg-dark-850 border border-white/5 space-y-1.5">
              <span className="text-emerald-400 font-mono font-bold block">03. 2-SEC CALL TO ACTION</span>
              <p className="text-slate-300">&ldquo;Comment &lsquo;LAUNCH&rsquo; and I&apos;ll send you the exact free starter blueprint.&rdquo;</p>
            </div>
          </div>
        </div>
      </div>
