...
export default function ProductLibrarySection() {
  ...
  return (
    <section id="pillars" className="relative py-20 md:py-28 border-t border-slate-200 dark:border-white/5 bg-slate-50 dark:bg-dark-950 overflow-hidden">
              ...
              >
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="h-12 w-12 rounded-xl bg-blue-50 dark:bg-indigo-500/10 border border-blue-200 dark:border-indigo-500/20 flex items-center justify-center text-blue-600 dark:text-indigo-400">
                  ...
                  <div>
                    ...
                    <span className="text-xs font-mono text-cyan-700 dark:text-cyan-400 font-semibold block mt-1">
                      ✦ {item.highlight}
                    </span>
                  </div>
